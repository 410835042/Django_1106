...
const transparent = new THREE.Color(0x000000, 0);
scene.background = black;

const back_Button = document.getElementById( 'back' );
back_Button.addEventListener( 'click', function () {
    if (scene.background == black){scene.background = transparent; console.log('transparent');}
    else if (scene.background == transparent){scene.background = black; console.log('black');}
    else {console.log('transparent');}
